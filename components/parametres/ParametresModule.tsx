...
export default function ParametresModule({ activeSociety, profile }: Props) {
  ...
  return (
    <div className="flex-1 flex overflow-hidden bg-[#0a0a0a]">
      <div className="w-56 bg-[#111111] border-r border-zinc-900 flex flex-col shrink-0">
        <div className="p-5 border-b border-zinc-900">
          <h2 className="text-white font-bold text-sm">⚙️ Mes paramètres</h2>
          <p className="text-zinc-500 text-[11px] mt-0.5">Personnalisation de votre espace</p>
        </div>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <div className="flex items-center justify-between px-6 py-3 border-b border-zinc-900 bg-[#111111]">
          <p className="text-zinc-500 text-xs">Paramètres personnels — uniquement pour votre compte</p>
          <button onClick={save} disabled={saving}
            className={`flex items-center gap-2 px-5 py-2 rounded-xl text-sm font-bold transition-all ${saved ? "bg-green-500/20 text-green-400 border border-green-500/30" : "text-black"}`}
            ...
            {saved ? "Sauvegardé !" : saving ? "En cours..." : "Sauvegarder"}
          </button>
        </div>
